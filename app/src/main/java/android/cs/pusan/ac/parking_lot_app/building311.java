...
public class building311 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?311";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building311);
        getSupportActionBar().setTitle("Building 311");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building311.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
