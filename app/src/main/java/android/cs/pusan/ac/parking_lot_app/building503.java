...
public class building503 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?503";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building503);
        getSupportActionBar().setTitle("Building 503");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building503.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
