...
public class building507 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?507";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building507);
        getSupportActionBar().setTitle("Building 507");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building507.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
