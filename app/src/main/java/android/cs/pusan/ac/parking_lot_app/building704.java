...
public class building704 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?704";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building704);
        getSupportActionBar().setTitle("Building 704");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building704.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
