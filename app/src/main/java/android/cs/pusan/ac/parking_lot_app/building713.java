...
public class building713 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?713";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building713);
        getSupportActionBar().setTitle("Building 713");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building713.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
