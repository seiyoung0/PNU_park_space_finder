...
public class building208 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?208";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building208);
        getSupportActionBar().setTitle("Building 208");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building208.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
