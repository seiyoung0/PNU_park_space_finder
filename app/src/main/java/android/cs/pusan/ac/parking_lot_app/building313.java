...
public class building313 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?313";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building313);
        getSupportActionBar().setTitle("Building 313");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building313.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
