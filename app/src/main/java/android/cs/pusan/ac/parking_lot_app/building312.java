...
public class building312 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?312";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building312);
        getSupportActionBar().setTitle("Building 312");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building312.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
