...
public class building514 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?514";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building514);
        getSupportActionBar().setTitle("Building 514");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building514.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
