...
public class building603 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?603";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building603);
        getSupportActionBar().setTitle("Building 603");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building603.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
