...
public class building401 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?401";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building401);
        getSupportActionBar().setTitle("Building 401");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building401.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
