...
public class building419 extends AppCompatActivity {
    ...
    private String apiurl = "http://the4456.iptime.org:3030/app?419";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_building419);
        getSupportActionBar().setTitle("Building 419");
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    building419.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            try {
